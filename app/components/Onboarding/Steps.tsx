...
const Steps: React.FC<{
    ...
    let heading = "Let's get your Aisha device & account set up";
    let subHeading =
        "We want to make sure that your Aisha is set up to provide you the best experience possible.";

    if (step === 1) {
        if (selectedType === "doctor") {
            heading = "Hello Doctor!";
            subHeading =
                "With the following details we will be able to personalize your and your patients' Aisha experience.";
        } else {
            heading = "Hello there!";
            subHeading =
                "With the following details we will be able to personalize your Aisha experience.";
        }
    }
