    ...
    return (
        <div className="flex max-w-xl mx-auto w-full mt-8 flex-col lg:w-1/2 px-4  gap-2 text-left m-2">
            <p className="font-semibold text-2xl">
                Terms and Conditions for Aisha AI
            </p>
            <p className="font-light text-md">Last Updated: 2/24/25</p>
            <div className="flex flex-col gap-4 my-4">
                <p>
                    {`Welcome to Aisha AI ("we," "us," "our"). We offer engaging AI-characters on Aisha devices that you can also converse with anytime through our website `}
                    <a
                ...
                <p>
                    ...
                    services that are not owned or controlled by Aisha AI. We
                ...
                <p>
                    In no event shall Aisha AI, nor its directors, employees,
